...
import com.doan.a7_tahc.adapters.ChatAdapter;
import com.doan.a7_tahc.databinding.ActivityChatBinding;
import com.doan.a7_tahc.models.ChatMessage;
import com.doan.a7_tahc.models.User;
import com.doan.a7_tahc.network.ApiClient;
import com.doan.a7_tahc.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void init(){
        ...
        String a = receiverUser.image;
        chatAdapter = new ChatAdapter(chatMessages,
                a,preferenceManager.getString(Constants.KEY_USER_ID));
    ...
    private void setListeners(){
        ...
        {
            if(!binding.inputMessage.getText().toString().isEmpty() && binding.inputMessage.getText().toString() != null)
                sendMessage();
        });
